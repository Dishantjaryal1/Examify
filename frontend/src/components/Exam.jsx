  ...
  useEffect(() => {
    const fetchExam = async () => {
      try {
        ...
        examStartTime.current = Date.now();
        // Set initial timeRemaining immediately so UI updates from "will start soon"
        ...
        if (role === "student" && response.data.timeLimit) {
          ...
          // Ensure submittedRef is false before starting timer
          submittedRef.current = false;
          isAutoSubmitting.current = false;
          // Start timer immediately - no delay needed
